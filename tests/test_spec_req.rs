...
void test_round_robin_out (bind_address_: &str)
{
...
void test_req_only_listens_to_current_peer (bind_address_: &str)
{
    void *req = test_context_socket (ZMQ_REQ);
...
void test_req_message_format (bind_address_: &str)
{
    void *req = test_context_socket (ZMQ_REQ);
