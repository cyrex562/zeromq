...
{
    pub const prefix: String = String::from("tcp://127.0.0.1:");
...
{
    pub const prefix: String = String::from("tcp://[::1]:");
...
{
    pub const prefix: String = String::from("ipc://");
...
{
    pub const prefix: String = String::from("tipc://");
