...
# results for TCP:
INPUT_FILE_PUSHZmqPullCP_THROUGHPUT="results/pushZmqPullcp_thr_results.csv"
...
plot_throughput(INPUT_FILE_PUSHZmqPullCP_THROUGHPUT, 'ZeroMQ PUSH/PULL socket throughput, TCP transport', is_tcp=True)
