...
inline u64 get_uint64 (const unsigned char *buffer_)
{
    return ((static_cast<u64> (buffer_[0])) << 56)
           | ((static_cast<u64> (buffer_[1])) << 48)
           | ((static_cast<u64> (buffer_[2])) << 40)
           | ((static_cast<u64> (buffer_[3])) << 32)
           | ((static_cast<u64> (buffer_[4])) << 24)
           | ((static_cast<u64> (buffer_[5])) << 16)
           | ((static_cast<u64> (buffer_[6])) << 8)
           | (static_cast<u64> (buffer_[7]));
}
}
